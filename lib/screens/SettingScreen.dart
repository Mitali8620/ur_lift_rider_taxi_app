...
import 'package:urmusic_world/screens/theme.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            settingItemWidget(Ionicons.thermometer,  language.changeTheme, () {
              launchScreen(context, ThemeScreen(), pageRouteAnimation: PageRouteAnimation.Slide);
            }, isLast: true),
